 ...
 */
static char *font = "JetBrains Mono:pixelsize=20:style=medium:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
    "Noto Color Emoji:pixelsize=10:style=regular:antialias=true:autohint=true"
};
#endif // FONT2_PATCH
